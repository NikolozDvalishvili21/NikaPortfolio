...
export const personal = {
  ...
  shortBio:
    "I'm a developer passionate about building beautiful, performant web applications. With a focus on clean code and thoughtful design, I create products that users love to interact with.",
  longBio: [
    "I'm a developer with a passion for creating exceptional digital experiences. I combine technical expertise with an eye for design to build applications that are both powerful and beautiful.",
  ...
  resumeUrl: "/Nikoloz_Dvalishvili_DEV.pdf",
